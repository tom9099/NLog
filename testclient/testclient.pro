...
else:unix:!macx:CONFIG(release, debug|release): LIBS += -L$$PWD/../build-nshared-Desktop_Qt_5_7_0_GCC_64bit-Release/ -lnshared
else:unix:!macx:CONFIG(debug, debug|release): LIBS += -L$$PWD/../build-nshared-Desktop_Qt_5_7_0_GCC_64bit-Debug/ -lnshared
